...
async function main() {
    ...
    filesCommand
        .command("download")
        .description(
            "Downloads and decrypts file from remote storage using resource on <resourcePath> to the <localPath>"
        )
    ...
    filesCommand
        .command("delete")
        .description("Deletes file in remote storage using resource on <resourcePath>")
        .argument("resourcePath", "A path to resource file (generated by upload command)")
