        ...
        page: {
            ...
            edges?: Array<{
                ...
                node?: {
                    ...
                    authority?: string | null;
                    consumer: string;
                    orderHoldDeposit?: string | null;
                    depositSpent?: string | null;
                    offerType: TOfferType;
                    parentOrder?: { __typename?: "ParentOrder"; id: string } | null;
                    offerInfo?: {
                        __typename?: "OfferInfo";
                        name: string;
                        description: string;
                    ...
                    orderInfo: {
                        ...
                        offer: string;
                        status: string;
                        args: { __typename?: "OrderArgs"; slots?: number | null };
                    };
                    origins?: {
                        __typename?: "Origins";
                        createdBy: string;
    ...
    result: {
        ...
        page: {
            ...
            edges?: Array<{
                __typename?: "OrderEdge";
                cursor?: string | null;
                node?: { __typename?: "Order"; id: string } | null;
            }> | null;
            pageInfo?: {
                __typename?: "OrderPageInfo";
                endCursor?: string | null;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        ...
        TeeTransfer(
            variables?: TeeTransferMutationVariables,
            requestHeaders?: Dom.RequestInit["headers"]
        ): Promise<TeeTransferMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<TeeTransferMutation>(TeeTransferDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders,
                    }),
                "TeeTransfer",
